...
<table width="100%">
  <tr>
    <td width="50%">
      ...
      <p>Recebe dois números inteiros e exibe todos os números que estão no intervalo compreendido por eles.</p>
    </td>
    <td width="50%">
      <img src="./exemplos/exercicio10.gif" alt="Demonstração Exercício 10">
    </td>
  </tr>
</table>
